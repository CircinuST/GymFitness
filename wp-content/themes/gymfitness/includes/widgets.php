...
class GymFitness_Clases_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) { //Es lo que se va a ver en pantalla
?>
...
<?php
    ...
    public function form( $instance ) { //Añade un formulario
...
<?php
	...
	public function update( $new_instance, $old_instance ) { //Para modificar el valor
        $instance = array();
