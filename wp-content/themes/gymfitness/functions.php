...
//******************FUNCION PARA HABILITAR CAJA DE IMAGENES DESTACADAS******************
...
function gymfitness_menus(){
    register_nav_menus(array(                    //Es el textDomain que esta en style.css
...
function gymfitness_scripts_styles(){
    ...
    if(is_front_page()){
        ...
        wp_enqueue_script('anime', 'https://cdnjs.cloudflare.com/ajax/libs/animejs/2.0.2/anime.min.js', array(), '1.0.2', true);
    }
...
//******************FUNCION PARA IMAGENES DINAMICAS COMO BACKGROUND******************
function gymfitness_hero_imagen(){
    //Obtener Id de la pag principal
